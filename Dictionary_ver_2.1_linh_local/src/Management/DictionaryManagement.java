...
public class DictionaryManagement {
    ...
    public void modifyWord(String word, String target, String explain) {
        Dictionary.hashMap.replace( target, explain);
    }
    
    //Tim mot tu trong tu dien
    public boolean ditionaryLookUp(String target) {
        return (Dictionary.hashMap.get(target).equalsIgnoreCase("")); 
    }
